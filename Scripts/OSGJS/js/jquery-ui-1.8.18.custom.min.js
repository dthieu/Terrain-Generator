 ...
 * http://docs.jquery.com/UI
 ...
 Nó cung cấp sự tương tác, các widget, hiệu ứng, và đề tài cho 
 việc tạo ra các ứng dụng Internet phong phú.

 Đặc điểm của thư viện:
 - Tốt cho các ứng dụng web tương tác cao
 - Mã nguồn mở và miễn phí để sử dụng
 - Cơ chế chủ đề mạnh mẽ
 - Ổn định và duy trì thân thiện
